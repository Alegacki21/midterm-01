...
public class SavingsAccount extends Account {
    ...
    public void applyInterest() {
        ...
        setBalance(getBalance() + interest); // Directly update the balance
        logTransaction("INTEREST", interest); // Only log once as INTEREST
    }
    ...
    public void withdraw(double amount) {
        ...
        // Directly subtract from balance and log the transaction
